...
class Clock extends Component {
    // When <Clock /> is passed to ReactDOM.render(), React calls the constructor of the Clock component. Since Clock needs to display the current time, it initializes this.state with an object including the current time.
    constructor(props) {
      super(props)
      this.state = {
        date: new Date()
